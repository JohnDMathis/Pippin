...
namespace IntelShell
{
    public class Bootstrapper : UnityBootstrapper
    {
        ...
        {
//            var catalogUri = new Uri("/IntelShell;component/ModuleCatalog.xaml", UriKind.Relative);
            var catalogUri = new Uri("ModuleCatalog.xaml", UriKind.Relative);
        ...
        {
            ShellView shell = Container.Resolve<ShellView>();
        ...
        protected override void InitializeModules()
        {
            ...
            Container.Resolve<IEventAggregator>().IntelShellStartup();
